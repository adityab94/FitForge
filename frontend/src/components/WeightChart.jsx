...
function CustomTooltip({ active, payload, selectedRate }) {
  ...
  return (
    <div style={{ background: '#1C2D35', border: '1px solid rgba(217,119,87,0.15)', borderRadius: 14, padding: '14px 16px', minWidth: 230, boxShadow: '0 8px 32px rgba(0,0,0,0.4)' }}>
      <p style={{ fontFamily: 'Outfit, sans-serif', color: '#3D1F0A', fontWeight: 700, fontSize: 13, marginBottom: 8 }}>
        Week {data.week}
      </p>
      {data.actual && (
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6, paddingBottom: 6, borderBottom: '1px solid rgba(217,119,87,0.1)' }}>
      ...
      {data.bmi_075 && (
        <div style={{ marginTop: 8, paddingTop: 6, borderTop: '1px solid rgba(217,119,87,0.1)' }}>
        ...
        <div className="glass-card p-4 md:p-6 chart-container">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-5">
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-xl bg-[#D97757]/10">
                <TrendingDown size={18} className="text-[#D97757]" strokeWidth={1.5} />
              </div>
              <div>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: `1.5px solid ${isActive ? rate.color : 'rgba(217,119,87,0.12)'}`,
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    border: `1px solid ${isActive ? `rgba(${rate.colorRgb},0.4)` : 'rgba(217,119,87,0.1)'}`,
          ...
          <div className="h-[280px] md:h-[340px]" data-testid="weight-chart">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={chartData} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
                ...
                <ReferenceLine y={goalKg} stroke="#D97757" strokeDasharray="8 4" strokeWidth={1.5}
                  strokeOpacity={0.6}
                  label={{ value: `Goal: ${goalKg}kg`, position: 'right', fill: '#D97757', fontSize: 11 }} />
