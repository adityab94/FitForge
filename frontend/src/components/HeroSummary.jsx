  ...
  return (
    <TooltipProvider delayDuration={200}>
      <Tooltip>
        ...
        <TooltipContent side="top" className="max-w-[200px] text-[11px] leading-relaxed" style={{ background: '#1C2D35', color: '#3D1F0A', border: '1px solid rgba(217,119,87,0.15)' }}>
          {text}
        </TooltipContent>
      </Tooltip>
    </TooltipProvider>
  ...
  return (
    <div className="relative w-20 h-20 mx-auto mb-2">
      <svg viewBox="0 0 100 100" className="w-full h-full -rotate-[135deg]">
        <circle cx="50" cy="50" r="38" fill="none" stroke="rgba(217,119,87,0.1)" strokeWidth="8" strokeLinecap="round" strokeDasharray={`${circumference * 0.75} ${circumference * 0.25}`} />
...
function HealthScoreRing({ score }) {
  ...
  const color = score >= 70 ? '#075056' : score >= 40 ? '#D97757' : '#EF4444';

  return (
    <div className="relative w-[76px] h-[76px]">
      <svg viewBox="0 0 80 80" className="w-full h-full -rotate-90">
        <circle cx="40" cy="40" r="32" fill="none" stroke="rgba(217,119,87,0.1)" strokeWidth="5" />
    ...
    <div className="flex items-center gap-2">
      ...
      <div className="flex gap-0.5">
        {Array.from({ length: goal }).map((_, i) => (
          <Droplets key={i} size={14} style={{ color: i < glasses ? '#075056' : 'rgba(217,119,87,0.15)', transition: 'color 0.2s' }} />
        ))}
      </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-4">
          ...
          <div className="glass-card p-4 md:p-5 kpi-bmi anim-scale-in delay-100" data-testid="kpi-bmi">
            <div className="flex items-center gap-1 mb-3">
              <Activity size={14} style={{ color: '#D97757' }} strokeWidth={2} />
            ...
            <p className="text-center text-xs mt-1" style={{ color: { blue: '#3D1F0A', green: '#075056', orange: '#D97757', red: '#EF4444' }[stats.bmi_color] }}>
              {stats.bmi_category}
            </p>
          </div>
          ...
          <div className="glass-card p-4 md:p-5 kpi-deficit anim-scale-in delay-300" data-testid="kpi-deficit">
            <div className="flex items-center gap-1 mb-3">
              <Target size={14} style={{ color: '#D97757' }} strokeWidth={2} />
            ...
            {(() => {
              ...
              if (!stats.has_nutrition) return <p className="text-[10px] mt-1" style={{ color: 'rgba(217,119,87,0.5)' }}>Log food for exact deficit</p>;
              return null;
            })()}
          </div>
          ...
          <div className="glass-card p-4 md:p-5 kpi-streak anim-scale-in delay-400" data-testid="kpi-streak">
            <div className="flex items-center gap-1 mb-3">
              <Flame size={14} style={{ color: '#D97757' }} strokeWidth={2} />
            ...
            <div className="flex items-end gap-2 mt-2">
              <span className="text-3xl md:text-4xl stat-number glow-orange" style={{ color: '#D97757' }}>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-lg md:text-xl font-bold" style={{ fontFamily: 'Outfit, sans-serif' }}>
                <span style={{ color: '#D97757' }}>{stats.days_to_goal} days</span> to {stats.weight_to_lose}kg goal
              </p>
