...
export default function BodyComposition() {
  ...
  const catColor = result ? (
    ...
    result.category === 'Average' ? '#C7522A' : '#EF4444'
  ) : '#C7522A';
        ...
        <div className="glass-card p-4 md:p-6">
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-xl" style={{ background: 'rgba(199,82,42,0.1)' }}>
                <User size={18} style={{ color: '#C7522A' }} strokeWidth={1.5} />
              </div>
              <div>
            ...
            <TooltipProvider delayDuration={200}>
              <Tooltip>
                ...
                <TooltipContent side="left" className="max-w-[220px] text-[11px]" style={{ background: '#1C2D35', color: '#3D1F0A', border: '1px solid rgba(199,82,42,0.15)' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button type="submit" disabled={loading} className="btn-glow w-full py-2.5 rounded-xl text-sm font-semibold text-white transition-all disabled:opacity-50" style={{ background: '#C7522A' }} data-testid="body-comp-submit">
              ...
              <div className="flex flex-col items-center justify-center">
                <div className="relative w-[130px] h-[130px] mb-3">
                  <svg viewBox="0 0 120 120" className="w-full h-full -rotate-90">
                    <circle cx="60" cy="60" r="50" fill="none" stroke="rgba(199,82,42,0.1)" strokeWidth="8" />
                ...
                <div className="flex gap-6 mt-4 text-center">
                  ...
                  <div>
                    <p className="stat-number text-lg" style={{ color: '#C7522A' }}>{result.fat_mass}kg</p>
