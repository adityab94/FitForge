  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'linear-gradient(160deg, #FFFBF5 0%, #FFF5EB 40%, #FFEEDC 100%)' }} data-testid="login-page">
      <div className="w-full max-w-sm">
        <div className="glass-card p-8 anim-slide-up" style={{ background: 'rgba(255,255,255,0.55)', borderColor: 'rgba(184,84,60,0.15)' }}>
          <div className="text-center mb-8">
            ...
            />
            <h1 className="text-4xl font-bold tracking-tight" style={{ fontFamily: 'Outfit, sans-serif', color: '#B8543C' }} data-testid="login-logo">
              FitForge
            </h1>
          ...
          {loading ? (
            <div className="flex items-center justify-center py-6">
              <Loader2 size={28} className="animate-spin" style={{ color: '#B8543C' }} />
            </div>
          ) : (
            <>
                ...
                {pin.map((digit, idx) => (
                  <input
                    ...
                    style={{
                      ...
                      border: `1.5px solid ${error ? '#ef4444' : digit ? '#B8543C' : 'rgba(184,84,60,0.15)'}`,
                      color: '#3D1F0A',
