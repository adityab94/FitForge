  ...
  return (
    <div className="flex items-center justify-center gap-2 py-3 px-4" data-testid="date-nav">
      ...
      <div
        ...
        style={{ background: 'rgba(255,255,255,0.55)', border: '1px solid rgba(199,82,42,0.12)' }}
      >
        <Calendar size={12} style={{ color: 'rgba(61,31,10,0.55)' }} />
        <span
          className="text-sm font-medium"
          style={{ color: isToday ? '#C7522A' : '#3D1F0A', fontFamily: 'Outfit, sans-serif' }}
        >
          {label()}
        </span>
      </div>
      ...
      {!isToday && (
        <button
          ...
          style={{ background: 'rgba(199,82,42,0.15)', color: '#C7522A', border: '1px solid rgba(199,82,42,0.3)' }}
        >
          Today
        </button>
      )}
