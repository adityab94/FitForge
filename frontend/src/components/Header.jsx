      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1
            ...
            style={{ fontFamily: 'Outfit, sans-serif', color: '#D97757', textShadow: '0 0 20px rgba(217,119,87,0.3)' }}
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="avatar-upload" onClick={handleAvatarClick} data-testid="avatar-upload">
            <img src={avatarSrc} alt="Profile" className="w-10 h-10 rounded-full object-cover border-2" style={{ borderColor: 'rgba(217,119,87,0.15)' }} data-testid="avatar-image" />
