  ...
  return (
    <section className="px-4 md:px-6 py-3 anim-fade-in delay-700" data-testid="motivational-quote">
      <div className="max-w-5xl mx-auto">
        <div className="glass-card-static p-4 md:p-5 flex items-start gap-3" style={{ borderLeft: '2px solid rgba(217,119,87,0.3)' }}>
          <Quote size={18} style={{ color: '#D97757', flexShrink: 0, marginTop: 2 }} />
          <div>
