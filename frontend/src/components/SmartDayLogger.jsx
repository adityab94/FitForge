...
const STEPS = [
  { id: 'nutrition', icon: Zap, label: 'Nutrition', color: '#C7522A' },
...
export default function SmartDayLogger({ open, onClose }) {
  ...
  const handleSkip = () => {
    if (step < STEPS.length - 1) {
      ...
      setDone(true);
      confetti({ particleCount: 80, spread: 60, origin: { y: 0.6 }, colors: ['#C7522A', '#075056'] });
    }
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: 'linear-gradient(160deg, #FFF8F0 0%, #FFE0C0 100%)', border: '1px solid rgba(199,82,42,0.15)' }}
      ...
      >
        ...
        {done ? (
          <div className="text-center py-4" data-testid="smart-logger-done">
            ...
            <h2 className="text-xl font-bold mb-2" style={{ fontFamily: 'Outfit, sans-serif', color: '#C7522A' }}>
              Day logged!
            </h2>
          ...
          <>
              ...
              {STEPS.map((s, i) => {
                ...
                return (
                  <div
                    ...
                    style={{ background: i <= step ? s.color : 'rgba(199,82,42,0.15)' }}
                  />
                );
              })}
            </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    {['total', 'macros'].map(m => (
                      <button key={m} onClick={() => setNutMode(m)} data-testid={`wizard-mode-${m}`}
                        ...
                        style={{ background: nutMode === m ? '#C7522A' : 'rgba(199,82,42,0.1)', color: nutMode === m ? '#fff' : 'rgba(61,31,10,0.6)' }}>
                  ...
                  {nutMode === 'total' ? (
                    ...
                    <div className="space-y-2">
                      ...
                      {(carbs || protein || fat) && (
                        <p className="text-xs font-semibold" style={{ color: '#C7522A' }}>= {calcCalFromMacros()} cal total</p>
                      )}
                    </div>
                  )}
                </div>
                  ...
                  <div className="flex gap-1 mt-2 flex-wrap">
                    {[4, 6, 8, 10].map(n => (
                      <button key={n} onClick={() => setWaterVal(String(n))}
                        ...
                        style={{ background: waterVal === String(n) ? '#3B82F6' : 'rgba(199,82,42,0.1)', color: waterVal === String(n) ? '#fff' : 'rgba(61,31,10,0.6)' }}>
                        {n}
                      </button>
                    ))}
                  </div>
            ...
            <div className="flex gap-2">
              <button
                ...
                style={{ background: 'rgba(199,82,42,0.1)', color: 'rgba(61,31,10,0.6)' }}
